		...
		*/
		...
		function scheduleUpdateOnFiber(fiber, lane, eventTime) {
			...
			if (lane === SyncLane) if ((executionContext & LegacyUnbatchedContext) !== NoContext && (executionContext & (RenderContext | CommitContext)) === NoContext) {
				...
				if ((executionContext & DiscreteEventContext) !== NoContext && (priorityLevel === UserBlockingPriority$2 || priorityLevel === ImmediatePriority$1)) if (rootsWithPendingDiscreteUpdates === null) rootsWithPendingDiscreteUpdates = /* @__PURE__ */ new Set([root]);
		...
		function warnAboutUpdateOnUnmountedFiberInDEV(fiber) {
			...
			} else didWarnStateUpdateForUnmountedComponent = /* @__PURE__ */ new Set([componentName]);
